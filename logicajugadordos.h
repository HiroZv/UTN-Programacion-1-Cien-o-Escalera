#ifndef LOGICAJUGADORDOS_H_INCLUDED
#define LOGICAJUGADORDOS_H_INCLUDED
...
void logicajugadordos (int puntajejugadorDos, int& maxpuntajejugadorDos, string jugadorDos, int rondas, int dados[6], int valoresDados [3], int opcion, int& puntajeMaximo, string& nombreMaximo, int valorMaximo){
      ...
      interfazjugadordos (jugadorDos, puntajejugadorDos, rondas);
    ...
    switch (opcion){
     ...
     case 3:
      ...
      valoresDados [i] = sumarVector (dados, 6);
        ...
        maxpuntajejugadorDos = valoresDados [valorMaximo];
...
#endif // LOGICAJUGADORDOS_H_INCLUDED
